...
function App() {
  {
    /*const { ToastProvider } = useContext();*/
  }
                                ...
                                >
                                  ...
                                  <div className="py-1">
                                    <button
                                      ...
                                      className="block w-full text-start py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
                                    >
                                      {labels.delete}
                                    </button>
                                  </div>
